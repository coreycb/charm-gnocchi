...
#
#
#class GnocchiDebCharm(GnocchiCharm):
#
#    """
#    Charm for Juju deployment of Gnocchi via Deb
#    """
#
...
#
#
#class GnocchiSnapCharm(GnocchiCharm):
#
#    """
...
#    packages = ['ceph-common', 'python-rados']
#    snaps = ['gnocchi']
#
#    services = ['snap.gnocchi.metricd', 'snap.gnocchi.nginx', 'snap.gnocchi.uwsgi']
#
#    restart_map = {
#        GNOCCHI_CONF_SNAP: services,
...
class GnocchiSnapCharm(GnocchiCharm):
    ...
    def enable_webserver_site(self):
        """Enable Gnocchi NGINX site if rendered or installed"""
